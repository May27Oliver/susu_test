...
const LeanCanvasPage = (props) => {
  const [pageStep, setPageStep] = React.useState(0); //欄位出現順序state
  const [planFinish, setPlanFinish] = React.useState(false); //是否完成填表
    ...
    <div className={cx("lean-canvas-page-wrap")}>
      ...
      <div className={cx("lean-canvas-page-content")}>
        ...
        <div
          className={cx(
            "lean-startup-col",
            pageStep === 0 && "margin-bottom",
            pageStep > 0 && "next-step"
          )}
        >
        ...
        {pageStep === 1 && planFinish && (
          <div className={cx("loading-box")}>
            <div
              className={cx("loading-icon", spinLoading && "spin")}
              onClick={() => {
                setSpinLoading(true);
              }}
            ></div>
              ...
              <div className={cx("more-cards-col")}>
                <div className={cx("more-card")}>
                  ...
                  <div className={cx("more-card-content")}>
                    ...
                    <div className={cx("more-line")}>
                      <div className={cx("more-line-title", "left")}>
                        Typeform
                      </div>
