...
const MarketingPage = (props) => {
  ...
  const [rightStep, setRightStep] = React.useState(0);
      ...
      <div className={cx("marketing-page-content")}>
        <div className={cx("marketing-intro-col")}>
          ...
          <div className={cx("marketing-two-circle-col")}>
            <div
              className={cx("marketing-circle", "soft-power")}
              onClick={() => setLeftStep(1)}
            >
            ...
            <div
              className={cx("marketing-circle", "hard-power")}
              onClick={() => setRightStep(1)}
            >
                ...
                <div className={cx("hint-column")}>
                  <div className={cx("hint-content")}>
                    ...
                    <button
                      ...
                      onClick={() => setLeftStep(2)}
                    >
                      確定
                    </button>
                    {leftStep > 1 && <div className={cx("arrow-down")}></div>}
                  </div>
                </div>
              </>
            )}
              ...
              <>
                ...
                <div className={cx("hint-input-column")}>
                  ...
                  <div className={cx("hint-input-content")}>
                    ...
                    <button
                      className={cx("hint-button", "white-col")}
                      onClick={() => setLeftStep(3)}
                    >
                      確定
                    </button>
                  </div>
                  {leftStep > 2 && <div className={cx("arrow-down")}></div>}
                </div>
              </>
            )}
            {leftStep > 2 && (
              <>
                <div className={cx("hint-column")}>
                  <div className={cx("hint-content")}>
                    ...
                    <p>
                      每個創業公司的成功都是不同的。 也許成功是初創公司 A 每月有
                      500 個新註冊，而初創公司 B 認為成功是每月收入 50,000
                ...
                <div className={cx("hint-column")}>
                  <div className={cx("hint-content")}>
                    ...
                    <button
                      className={cx("hint-button")}
                      onClick={() => setLeftStep(4)}
                    >
                      確定
                    </button>
                  </div>
                  {leftStep > 3 && <div className={cx("arrow-down")}></div>}
                </div>
              </>
            )}
            {leftStep > 3 && (
              ...
              <>
                ...
                <div className={cx("hint-input-column")}>
                  ...
                  <div className={cx("hint-input-content")}>
                    ...
                    <div className={cx("hint-button-center")}>
                      <button
                        className={cx("hint-input-button")}
                        onClick={() => setRightStep(2)}
                      >
                        好的，我都了解了！
                      </button>
                      {rightStep > 1 && (
                ...
                <div className={cx("hint-column")}>
                  <div className={cx("hint-content")}>
                    ...
                    <div className={cx("hint-button-center")}>
                      <button
                        className={cx("hint-button")}
                        onClick={() => setRightStep(3)}
                      >
                        好的，我都了解了！
                      </button>
                    </div>
                  </div>
                  {rightStep > 2 && <div className={cx("arrow-down")}></div>}
                </div>
              </>
            )}
            {rightStep > 2 && (
